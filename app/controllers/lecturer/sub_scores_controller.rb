class Lecturer::SubScoresController < ApplicationController
  
  before_action :authenticate_lecturer!
  # before_action :load_class_subject, only: [:new, :create, :edit]
  # before_action :load_sub_core, only: [:edit, :update, :destroy]

  # # def new
  #   @sub_score = @class_subject.sub_scores.new
  ...
  # def create
  #   @sub_score = @class_subject.sub_scores.build sub_score_params
  #   if @sub_score.save
